...
API_TOKEN = '7037021493:AAGvIl-0CgVcv0vMq9vKpBvTQsD02pMYJXs'
...
async def show_main_menu(chat_id):
    ...
    photo_path = 'fotoobs/Frame 32.jpg'
...
async def handle_send_post(call: types.CallbackQuery):
    ...
    await call.message.answer("Пожалуйста, отправь свой пост с хештегом #100балльныйрепетитор. \n\n Или нажми на /start")
...
async def invite_friend(call: types.CallbackQuery):
    ...
    invite_link = f'https://t.me/tutor_100ballniy_soc_bot?start={call.from_user.id}'
    await call.message.answer(f'Вот твоя ссылка для приглашений: {invite_link}\nEё можно отправлять неограниченное количество раз 😉')
...
async def join_channels_and_chats(call: types.CallbackQuery):
    ...
    join_button_url = "https://t.me/addlist/yKeNFxgIQ9A0MDcy"
